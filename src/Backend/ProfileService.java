...
public class ProfileService {
    ...
    public void changeProfilePhoto(user_1 user, String newPhotoPath) throws IOException {
    ...
    public void changeCoverPhoto(user_1 user, String newPhotoPath) throws IOException {
        if (newPhotoPath == null || newPhotoPath.isEmpty()) {
    ...
    public void updateBio(user_1 user, String newBio) throws IOException {
    ...
    public void updatePassword(user_1 user, String newPassword) throws IOException {
    ...
    public void createPost(user_1 user, String text, String imagePath) throws IOException {
    ...
    public void deletePost(user_1 user, Post post) throws IOException {
