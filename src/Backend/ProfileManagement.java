...
public class ProfileManagement extends JFrame {
    ...
    public ProfileManagement(DatabaseManager databaseManager, user_1 user) {
        ...
        passwordField = new JPasswordField(currentUser.getHashedPassword());
    ...
    public static void main(String[] args) {
        try {
            ...
            user_1 mockUser = databaseManager.getUserById("123");
