...
public class DatabaseManager {
    ...
    public void updateUser(user_1 user) throws IOException {
    ...
    public user_1 getUserById(String userId) throws IOException {
    ...
    private String serializeUser(user_1 user) {
